      ...
      <div className=" flex flex-col border-white bg-[#f9f9f9] rounded-md">
        ...
        <div className="grid gap-8 grid-cols-5 p-6">
          <div className="">
            ...
            <h2 className="text-base text-[#3A3A3A]">Business</h2>
          </div>
          <div className="">
          ...
          <div className="">
            ...
            <h2 className="text-base text-[#3A3A3A]">SME</h2>
          </div>
          <div className="">
            <p className="text-xs text-[#575757]">Product Name</p>
            <h2 className="text-base text-[#3A3A3A]">Rice</h2>
          </div>
          <div className="">
            <p className="text-xs text-[#575757]">Country</p>
            <h2 className="text-base text-[#3A3A3A]">Cameroon</h2>
          </div>
          <div className="">
            <p className="text-xs text-[#575757]">HS Code</p>
            <h2 className="text-base text-[#3A3A3A]">0200-2000E</h2>
          </div>
          <div className="">
            <p className="text-xs text-[#575757]">Quantity</p>
            <h2 className="text-base text-[#3A3A3A]">100</h2>
          </div>
          <div className="">
            <p className="text-xs text-[#575757]">Unit</p>
            <h2 className="text-base text-[#3A3A3A]">Bags</h2>
          </div>
          <div className="">
