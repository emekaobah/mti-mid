...
export interface AdminServiceAnalysisProps {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Internal analysis of service trade patterns for policy development
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Services organizations want to import - identify market gaps
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Services organizations can export - identify competitive strengths
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-[300px]">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Strategic analysis of service trade patterns and opportunities
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-lg font-semibold">{requested[0]?.service}</div>
            <p className="text-xs text-muted-foreground">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Identify service trade imbalances and policy opportunities
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            {requested.slice(0, 5).map((requestedService, index) => {
              const offeredService = offered.find(
                (off) => off.service === requestedService.service
              );
              const gap = requestedService.count - (offeredService?.count || 0);
              return (
                  ...
                  <div className="flex space-x-2">
                    <div className="flex-1 bg-blue-100 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${
                            (requestedService.count / requested[0].count) * 100
                          }%`,
                        }}
                      />
                    </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base">Policy Recommendations</CardTitle>
          <CardDescription>
            Strategic recommendations for service trade development
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="font-medium">Service Export Promotion</h4>
                <p className="text-sm text-muted-foreground">
                  Develop targeted programs for {offered[0]?.service} sector
                  with {offered[0]?.count} export offers
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="font-medium">Market Access Strategy</h4>
                <p className="text-sm text-muted-foreground">
                  Address {requested[0]?.service} demand gap of{" "}
                  {requested[0]?.count} requests
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Invest in service sector infrastructure and skills development
                </p>
              </div>
            </div>
          </div>
